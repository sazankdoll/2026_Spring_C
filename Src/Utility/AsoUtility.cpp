...
void AsoUtility::DrawLineDir(const VECTOR& pos, const VECTOR& dir, int color, float len)
{
    ...
    DrawSphere3D(ePos, DRAW_SPHERE_RADIUS, DRAW_SPHERE_DIV, color, color, true);
}
