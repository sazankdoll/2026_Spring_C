...
public:
	//3D設定
	//ライト設定
	static constexpr VECTOR LIGHT_TYPE_DIR = { 0.3f, -0.7f, 0.8f };
	//fog設定
	...
	//タイマーの時間設定
	static constexpr float GAME_TIME = 180.0f;
	static constexpr float RESULT_TIME = 20.0f;

	//デルタタイム初期値
	static constexpr float DELTATIME = 1.0f / 60.0f;

	//デルタタイムリセット値
	static constexpr float DELTATIME_RESET = 0.016f;
