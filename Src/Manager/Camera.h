...
public:
	...
	//カメラの更新座標
	static constexpr VECTOR BEFORE_POS = { 0.0f,3000.0f,-500.0f };

	//90
	static constexpr float DEG90 = 90.0f;
	...
	//カメラ座標表示座標
	static constexpr int CAMERA_POS_DISP_X = 100;
	static constexpr int CAMERA_POS_DISP_Y = 10;
	...
	const Quaternion& GetQuaRotX(void) const;
	const Quaternion& GetQuaRotZ(void) const;
